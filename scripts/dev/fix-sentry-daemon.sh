...
#
# Usage:
#   ./scripts/dev/fix-sentry-daemon.sh              # start daemon
#   ./scripts/dev/fix-sentry-daemon.sh stop         # stop daemon (kills all child processes)
#   nohup ./scripts/dev/fix-sentry-daemon.sh &      # survives terminal close
#
# Logs:
